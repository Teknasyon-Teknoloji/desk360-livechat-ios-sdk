...
class EmojiDetector {
	...
	static let shared = EmojiDetector()
	...
	func containsEmoji(string: String) -> Bool {
	...
	@available(iOS 10.2, *)
	func isSimpleEmoji(_ string: String) -> Bool {
	...
	@available(iOS 10.2, *)
	func countEmoji(_ string: String) -> Int {
		var count = 0
		for char in string {
	...
	@available(iOS 10.2, *)
	func countNonEmoji(_ string: String) -> Int {
		var count = 0
		for char in string {
			if !checkForEmoji("\(char)") {
				count += 1
...
private extension EmojiDetector {
